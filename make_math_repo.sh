...
echo ""
echo ""
echo "NOTE: The math directory/repo just created is checked out to "
echo "      the branch another_fix_branch. Run git branch to see."
echo "NOTE: The file math.sh has been edited, but not added to the repo yet."
echo "      Run git status to see."
echo ""
echo ""
